  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved stream as @stream" do
        ...
        post :create, {:stream => { "href" => "invalid value" }}, valid_session
        assigns(:stream).should be_a_new(Stream)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested stream" do
        ...
        Stream.any_instance.should_receive(:update).with({ "href" => "MyString" })
        put :update, {:id => stream.to_param, :stream => { "href" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the stream as @stream" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Stream.any_instance.stub(:save).and_return(false)
        put :update, {:id => stream.to_param, :stream => { "href" => "invalid value" }}, valid_session
        assigns(:stream).should eq(stream)
      end
